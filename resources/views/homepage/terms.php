...
<div class="page-banner-area"
        style="background-image:url(img/man-holding-contract-his-new-office-job-after-interview.jpg); background-repeat: none; background-size: cover; background-position: center;">
        <div class="container">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="page-banner-content" data-aos="fade-right" data-aos-delay="50" data-aos-duration="500"
                        ...
                        <ul>
                            ...
                            <li class="text-white">Terms of Service</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="page-banner-image" data-aos="fade-left" data-aos-delay="50" data-aos-duration="500"
                        data-aos-once="true">
                        <img src="img/top-up-add-your-money-balance.png" alt="image" />
...
<p><i>This Terms of Service was last updated on February 1, 2023.</i></p>
<h3><span>1.</span> Our Website</h3>
<p>Our website address is: <?php print $siteUrl;?></p>
<blockquote class="blockquote">
<p>We collect certain data from you directly like information you enter yourself data about your participation in courses and data from third-party platforms you connect with snuff. We also collect some data automatically information about your device and what parts of our Services you interact with or spend time using.</p>
</blockquote>
