            ...
            <div class="nk-block-head">
                <div class="nk-block-between-md g-4">
                    <div class="nk-block-head-content">
                        <h2 class="nk-block-title fw-normal">Admins</h2>
                    </div>
                  <div>
                    ...
                    <table class="table table-orders">
                        <thead class="tb-odr-head">
                            <tr class="tb-odr-item">
                                ...
                                <th class="tb-odr-info">
                                    <span class="tb-odr-id">Role</span>
                                </th>
                                <th class="tb-odr-info">
                        ...
                        <tbody class="tb-odr-body">
                            @forelse($users as $key => $item)                              
                                <tr class="tb-odr-item">
                                    ...
                                    <td class="tb-odr-info">
                                        <span class="tb-odr-id" style="font-weight: bold;">{{$item->role}}</span>
                                    </td>
                                    <td class="tb-odr-info">
                                        <span class="tb-odr-id" style="font-weight: bold;">{{ Date::parse($item->created_at)->format('jS F Y') }}</span>
                                    </td>
                                    <td class="">
                                        <a href="{{route('admin.users.details', ['user' => $item->username])}}" class="btn btn-sm btn-primary" >Suspend</a>
                                        <a href="{{route('admin.users.details', ['user' => $item->username])}}" class="btn btn-sm btn-primary" >Delete</a>
                                    </td>
                                </tr>
                            @empty
